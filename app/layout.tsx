              ...
              <footer className="bg-gray-50 border-t py-12 mt-16">
                <div className="container mx-auto px-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div>
                      <h3 className="font-bold text-lg mb-4">FertiTerra Technologies</h3>
                      <p className="text-gray-600 text-sm">
                        Empowering your fertility journey with advanced testing, expert guidance, and compassionate care
                        across Africa.
                      </p>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-2 text-sm">
                        <li>
                          <a href="/about/founders-story" className="text-gray-600 hover:text-purple-600">
                            Our Story
                          </a>
                        </li>
                        <li>
                          <a href="/test-kits" className="text-gray-600 hover:text-purple-600">
                            Test Kits
                          </a>
                        </li>
                        <li>
                          <a href="/consultation" className="text-gray-600 hover:text-purple-600">
                            Consultation
                          </a>
                        </li>
                        <li>
                  ...
                  <div className="border-t pt-8 text-center text-gray-600 text-sm">
                    <p>&copy; {new Date().getFullYear()} FertiTerra Technologies. All rights reserved.</p>
                  </div>
                </div>
              </footer>
            </div>
